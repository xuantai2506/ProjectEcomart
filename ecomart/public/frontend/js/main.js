...
(function($) {
    ...
    $('.category-heading').on('click', function() {
        $('.category-menu-list').slideToggle(100);
    });
    $('.category-heading-mobile').on('click', function() {
        $('.category-menu-list-mobile').slideToggle(100);
    });
    ...
    /*----------------------------------- 
              5.2 Related Blogs slider Active 
            ----------------------------------*/
    $('.related-blogs')
        .on('changed.owl.carousel initialized.owl.carousel', function(event) {
            $(event.target)
...
----------------------------------*/
    ...
    * ---------------------------*/
    ...
    $(".payment_method_cod-li").on('click', function() {
        $(".payment_method_cod").show(500);
        $(".payment_method_cheque").hide(500);
        $(".payment_method_paypal").hide(500);
    });
    /*----------------------------------
