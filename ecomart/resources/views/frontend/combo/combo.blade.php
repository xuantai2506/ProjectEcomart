                    ...
                    <div class="col-lg-3 order-lg-1 order-2">
                        ...
                        <div class="widget widget-shop-categories categories2">
                            ...
                            <div class="widget-content">
                                <ul class="product-categories">
                                    @if(isset($other_id))
                                    <li><a href="{{URL::to('cua-hang&other='.$other_id.'&price=1')}}">Giá dưới 500.000đ</a></li>
                                    <li><a href="{{URL::to('cua-hang&other='.$other_id.'&price=2')}}">500.000đ - 1.000.000đ</a></li>
                                    <li><a href="{{URL::to('cua-hang&other='.$other_id.'&price=3')}}">1.000.000đ - 3.000.000</a></li>
                                    <li><a href="{{URL::to('cua-hang&other='.$other_id.'&price=4')}}">3.000.000 - 5.000.000</a></li>
                                    <li><a href="{{URL::to('cua-hang&other='.$other_id.'&price=5')}}">5.000.000 - 8.000.000</a></li>
                                    <li><a href="{{URL::to('cua-hang&other='.$other_id.'&price=6')}}">8.000.000 - 10.000.000</a></li>
                                    <li><a href="{{URL::to('cua-hang&other='.$other_id.'&price=7')}}">Lớn hơn 10.000.000</a></li>
                                    @else
                                    <li><a href="{{URL::to('cua-hang&price=1')}}">Giá dưới 500.000đ</a></li>
                                    <li><a href="{{URL::to('cua-hang&price=2')}}">500.000đ - 1.000.000đ</a></li>
                                    <li><a href="{{URL::to('cua-hang&price=3')}}">1.000.000đ - 3.000.000</a></li>
                                    <li><a href="{{URL::to('cua-hang&price=4')}}">3.000.000 - 5.000.000</a></li>
                                    <li><a href="{{URL::to('cua-hang&price=5')}}">5.000.000 - 8.000.000</a></li>
                                    <li><a href="{{URL::to('cua-hang&price=6')}}">8.000.000 - 10.000.000</a></li>
                                    <li><a href="{{URL::to('cua-hang&price=7')}}">Lớn hơn 10.000.000</a></li>
                                    @endif
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="widget-content">
                                <ul class="product-categories">
                                    @if(isset($id_price))
                                        ...
                                        <li><a href="{{URL::to('cua-hang&price='.$id_price.'&other='.$others['others_id'])}}">{{$others['name']}}</a></li>
                                        @endforeach
                                    @else
                                        @foreach($other as $others)
                                        <li><a href="{{URL::to('cua-hang&other='.$others['others_id'])}}">{{$others['name']}}</a></li>
                                        @endforeach
                                    @endif
                                </ul>
                            </div>
