                                ...
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <table class="table table-hover" style="width: 70%;">
                                        ...
                                        <tr>
                                            ...
                                            <td><input class="form-control" type="text" value="{{$gallery['name']}}" id="name" name="name" maxlength="200" required></td>
...
<!-- 
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <textarea class="form-control" value="{{$gallery['comment']}}" name="comment" rows="3"></textarea>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <textarea class="form-control" id="content" name="content" style="visibility: hidden; display: none;">
                                                	{!! Request::old('content', $gallery['content']) !!}
                                                </textarea>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="tth-gp-r"><input value="{{$gallery['description']}}" class="form-control" type="text" name="description" maxlength="255"  ></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="tth-gp-r tth-gp-b">
                                                <input class="form-control" value="{{$gallery['keywords']}}" type="text" name="keywords" data-role="tagsinput" >
                                            </td>
            ...
            <script type="text/javascript">
                $('.file-img').fileinput({
                    initialPreview: [
                        "<img src='<?php echo asset('upload/gallery/'.$gallery['images'])  ?>' class='file-preview-image' >"
                    ],
