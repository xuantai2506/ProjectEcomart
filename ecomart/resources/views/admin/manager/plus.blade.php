                ...
                <div class="col-lg-12">
                    <div class="panel panel-default panel-no-border">
                        <div class="table-responsive">
                            <a class="btn-add-new" href="{{URL::to('admin/plus_add')}}">Thêm trang</a>
                            <form method="post" id="deleteArt">
                                    ...
                                    <table class="table display table-manager dataTable no-footer" cellspacing="0" cellpadding="0" id="dataTablesList" role="grid">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="dataTablesList" rowspan="1" colspan="1" aria-label="Tên nhóm: kích hoạt để sắp xếp cột tăng dần" style="width: 137px;">Alias</th>
                                                <th class="sorting" tabindex="0" aria-controls="dataTablesList" rowspan="1" colspan="1" aria-label="Trạng thái: kích hoạt để sắp xếp cột tăng dần" style="width: 115px;">Tên Trang</th>
                                                <th class="sorting" tabindex="0" aria-controls="dataTablesList" rowspan="1" colspan="1" aria-label="Số thành viên: kích hoạt để sắp xếp cột tăng dần" style="width: 149px;">Hiển Thị</th>
                                        ...
                                        <tbody>
                                        <?php $stt = 0 ?>
                                        @foreach($get_page as $get_pages)
                                            <tr role="row" class="odd">
                                                <td align="center" class="sorting_1">{{++$stt}}</td>
                                                <td align="center">{{$get_pages['alias']}}</td>
                                                <td align="center">{{$get_pages['name']}}</td>
                                                <td align="center">
                                                    <input type="checkbox"
                                                    {{$get_pages->is_active == 1 ? "checked" : ""}}
                                                    id="show_{{$get_pages['page_id']}}" 
                                                    class="is_active_page" 
                                                    value="{{$get_pages['page_id']}}"
                                                    name="is_active">
                                                ...
                                                <td align="center">{{ date("Y-m-d H:i:s", strtotime($get_pages['updated_at'])) }}</td>
                                                <td align="center">admin</td>
                                                <td class="details-control" align="center">
                                                    <div class="checkbox">
                                                        <a href="{{URL::to('admin/page_edit&id_edit='.$get_pages['page_id'])}}"><img data-toggle="tooltip" data-placement="top" title="Chỉnh sửa" src="images/setting.svg"></a> &nbsp;
                                                        <label class="checkbox-inline">
                                                        <input type="checkbox" data-toggle="tooltip" data-placement="top" title="Xóa" class="checkboxArt" name="delete[]" value="{{$get_pages['page_id']}}">
                                                    </label>&nbsp;&nbsp;
                                                    </div>
                                                </td>
                                            </tr>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6" align="right" style="padding: 7px 0;">
                                        <label class="radio-inline"><input type="checkbox" id="selecctall" data-toggle="tooltip" data-placement="top" name="delete_all" title="Chọn xóa tất cả"></label>
