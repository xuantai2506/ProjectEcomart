...
@section('content')
        <div id="page-wrapper" style="min-height: 165px;">
            <div class="row">
                <h2 class="title_sp">Chỉnh sửa phần bổ sung</h2>
                <ol class="breadcrumb">
                    <li>
                        <a href="{{URL::to('admin/home')}}">Trang chủ</a>
                    </li>
                    <li>
                        Chỉnh sửa phần  bổ sung
                    </li>
                </ol>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default khoangcach">
                        <div class="panel-heading">
                            <i class="fa fa-files-o"></i>Chỉnh sửa phần bổ sung
                        </div>
                                ...
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <table class="table table-hover" style="width: 70%;">
                                        ...
                                        <tr>
                                            ...
                                            <td><input class="form-control" value="{{$get_page_edit['alias']}}" type="text" id="alias" name="alias" maxlength="200" required></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input class="form-control" value="{{$get_page_edit['name']}}" type="text" id="name" name="name" maxlength="200" required></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <textarea class="form-control" value="" name="comment" rows="3">{{$get_page_edit['comment']}}</textarea>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <textarea class="form-control" id="content" name="content" style="visibility: hidden; display: none;">
                                                        {!! Request::old('content', $get_page_edit['content']) !!}
                                                </textarea>
                                            </td>
                                        </tr>
