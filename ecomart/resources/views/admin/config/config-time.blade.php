                                ...
                                <form method="post">
                                    ...
                                    <table class="table table-hover" style="width: 70%;">
                                        ...
                                        @foreach($getConstant as $getConstants)
                                            ...
                                            @if($getConstants['constant'] == 'timezone')
                                            <tr>
                                                <td width="200px" class="ver-top">
                                                    <label>{{$getConstants['name']}}:</label>
                                                </td>
                                                <td>
                                                    <select name="value_constant[]" class="form-control">
                                                        @foreach($timezone as $key => $value)
                                                        <option 
                                                        <?php 
                                                            if($getConstants['value'] == $value){
                                                                echo "selected";
                                                            }else {
                                                                echo "";
                                                            }
                                            ...
                                            @else 
                                            <tr>
                                                <td width="200px" class="ver-top"><label>{{$getConstants['name']}}:</label></td>
                                                <td>
                                                    <input type="text" name="value_constant[]" value="{{$getConstants['value']}}" class="form-control form-control-line">
                                                </td>
                                            </tr>
                                            @endif
                                            @endforeach
