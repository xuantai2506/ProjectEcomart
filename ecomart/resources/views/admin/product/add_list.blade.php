                ...
                <div class="col-lg-12">
                    <div class="panel panel-default khoangcach">
                        <div class="panel-heading">
                            <i class="fa fa-files-o"></i> Thêm sản phẩm
                        </div>
                                    ...
                                    <table class="table table-hover">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td width="88%" colspan="3"><input class="form-control" value="{{old('name')}}" type="text" id="name" name="name" maxlength="255" value="" required="required"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td width="38%" class="ver-top"><input class="form-control" type="text" name="images_note" maxlength="255" value=""></td>
                                            </tr>
                                            <tr>
                                                <td><label>Giá:</label></td>
                                                <td><input class="form-control auto-number" value="{{old('price')}}" type="text" name="price" data-a-sep="." data-a-dec="," data-v-max="9999999999"  data-v-min="0" maxlength="15" placeholder="0 =  Liên hệ" value=""></td>
                                                <td><label>Giá khuyến mãi:</label></td>
                                                <td><input class="form-control auto-number" type="text" value="{{old('sale')}}" name="sale" data-a-sep="." data-a-dec="," data-v-max="9999999999" data-v-min="0" maxlength="15" placeholder="0 =  Không khuyến mãi" value=""></td>
                                            </tr>
                                            <tr>
                                                <td><label>Nhà sản xuất:</label></td>
                                                <td colspan="3">
                                                    <select name="producer" class="form-control">
                                                        <option>Lựa chọn nhà sản xuât</option>
                                                        @foreach($producer as $producers)
                                                        <option value="{{$producers['others_id']}}">{{$producers['name']}}</option>
                                                        @endforeach
                                                    </select>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3">
                                                    <input id="album" class="form-control file" type="file" name="upload_images[]" data-max-file-count="15" accept="image/*" multiple>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><label>Combo:</label></td>
                                                <td colspan="3">
                                                    <label class="radio-inline"><input type="radio" name="combo" value="0" checked=""> Đóng&nbsp;</label>
                                                    <label class="radio-inline"><input type="radio" name="combo" value="1"> Mở&nbsp;</label>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3">
                                                    <label class="radio-inline"><input type="radio" name="hot" value="0" checked=""> Đóng&nbsp;</label>
                                                    <label class="radio-inline"><input type="radio" name="hot" value="1"> Mở&nbsp;</label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><label>Flash Sale:</label></td>
                                                <td colspan="3">
                                                    <label class="radio-inline"><input type="radio" name="pin" value="0" checked=""> Đóng&nbsp;</label>
                                                    <label class="radio-inline"><input type="radio" name="pin" value="1"> Mở&nbsp;</label>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="tth-gp-r" colspan="3"><input class="form-control" value="{{old('title')}}" type="text" name="title" maxlength="255" value=""></td>
                                            </tr>
                                            <tr>
                                                <td class="tth-gp-l"><label>Description:</label></td>
                                                <td class="tth-gp-r" colspan="3"><input class="form-control" type="text" value="{{old('description')}}" name="description" maxlength="255" value=""></td>
                                            </tr>
                                            <tr>
                                                <td class="tth-gp-l tth-gp-b"><label>Keywords:</label></td>
                                                <td class="tth-gp-r tth-gp-b" colspan="3"><input class="form-control" type="text" value="{{old('keywords')}}" name="keywords" data-role="tagsinput" value="" style="display: none;">
