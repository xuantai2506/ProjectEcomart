...
@section('content')
        <div id="page-wrapper" style="min-height: 165px;">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default khoangcach">
                        <div class="panel-heading">
                            <i class="fa fa-files-o"></i> Chỉnh sửa danh mục Sản Phẩm
                        </div>
                                ...
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <table class="table table-hover" style="width: 70%;">
                                        ...
                                        <tr>
                                            ...
                                            <td><input class="form-control" type="text" id="name" value="{{$product_menu['name']}}" name="name" maxlength="200" required></td>
                                       ...
                                       <!--  <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <textarea class="form-control" name="comment" rows="3">{{$product_menu['comment']}}
                                                </textarea>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="tth-gp-r"><input class="form-control" type="text" value="{{$product_menu['title']}}"  name="title" maxlength="255"  ></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="tth-gp-r"><input class="form-control" value="{{$product_menu['description']}}" type="text" name="description" maxlength="255"  ></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="tth-gp-r tth-gp-b">
                                                <input class="form-control" type="text" name="keywords" value="{{$product_menu['keywords']}}" data-role="tagsinput" >
                                            </td>
            ...
            <script type="text/javascript">
                $('.file-img').fileinput({
                    initialPreview: [
                        "<img src='<?php echo asset('upload/product/'.$product_menu['images'])  ?>' class='file-preview-image' >"
                    ],
