                                    ...
                                    <table class="table table-hover" style="width: 70%;">
                                       ...
                                       <!--  <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="tth-gp-r"><input class="form-control" value="{{old('title')}}" type="text" name="title" maxlength="255"  ></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="tth-gp-r"><input class="form-control" type="text" value="{{old('description')}}" name="description" maxlength="255"  ></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="tth-gp-r tth-gp-b">
                                                <input class="form-control" type="text" name="keywords" value="keywords" data-role="tagsinput" >
                                            </td>
