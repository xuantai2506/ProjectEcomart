                                ...
                                <div class="tab-pane fade active in" id="info">
                                    <form id="change_info" action="update_profile" name="changeInfo" method="post" enctype="multipart/form-data">
                                        ...
                                        <table class="table table-hover" style="width: 70%;">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><input class="form-control" type="text" name="email" id="email" readonly="" value="{{$get_profile['email']}}"></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td><label>Ngày sinh(d-m-y):</label></td>
                                                    <td><input class="form-control" type="text" name="birthday" style="width: 120px;" value="{{$get_profile['birthday']}}"></td>
                                                </tr>
                                                <tr>
                                        ...
                                        <script>
                                            ...
                                            $('.file-img').fileinput({
                                                initialPreview: [
                                                    "<img src='<?php echo asset('upload/admin/user/'.$get_profile['images'])  ?>' class='file-preview-image' >"
                                                ],
